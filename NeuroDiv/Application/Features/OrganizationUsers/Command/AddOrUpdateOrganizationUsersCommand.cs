...
namespace Application.Features.OrganizationUsers.Command
{
    public class AddOrUpdateOrganizationUsersCommand : IRequest<Response<bool>>
    {
        ...
        public class AddOrUpdateOrganizationUsersCommandHandler : IRequestHandler<AddOrUpdateOrganizationUsersCommand, Response<bool>>
        {
            private readonly IMapper _mapper;
            private readonly IAuthenticatedUserService _user;
            private readonly ICommentRepositoryAsync _commentRepository;

            public AddOrUpdateOrganizationUsersCommandHandler(IMapper mapper, IAuthenticatedUserService user,
            ...
            public async Task<Response<bool>> Handle(AddOrUpdateOrganizationUsersCommand command, CancellationToken cancellationToken)
            {
